 ...
 */
public class SomewhatFair_Copied_StoreQueueCursor extends AbstractPendingMessageCursor {

    private static final Logger LOG = LoggerFactory.getLogger(SomewhatFair_Copied_StoreQueueCursor.class);
     ...
     * @param queue
     */
    public SomewhatFair_Copied_StoreQueueCursor(Broker broker, Queue queue) {
